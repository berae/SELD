...
def evaluate_seed(variant, seed, split, thresholds, device, manifest=None, run_label=None):
    if manifest is None:
    ...
    directories = {threshold: prediction_dir(run_label, seed, split, threshold) for threshold in thresholds}
    for path in directories.values():
        cls_feature_class.delete_and_create_folder(path)
