...
class Losses:
    def __init__(self, cfg):
        ...
        self.lambda_velocity = cfg['training']['lambda_velocity']
        ...
        self.names = ['loss_all'] + [loss.name for loss in self.losses] + ['loss_velocity']
    ...
    def calculate(self, pred, target, epoch_it=0):
        ...
        loss_velocity = (velocity_elementwise * velocity_mask).sum() / velocity_mask.sum().clamp_min(1.0)
