...
def intensityvector(input, melW):
    ...
    # DCASE FOA is AmbiX/ACN ordered as [W, Y, Z, X].  Convert the
    # directional channels to Cartesian [X, Y, Z] before constructing IV.
    Pref_real, Pref_imag = sig_real[:,0,...], sig_imag[:,0,...]
    Px_real, Px_imag = sig_real[:,3,...], sig_imag[:,3,...]
    Py_real, Py_imag = sig_real[:,1,...], sig_imag[:,1,...]
    Pz_real, Pz_imag = sig_real[:,2,...], sig_imag[:,2,...]
