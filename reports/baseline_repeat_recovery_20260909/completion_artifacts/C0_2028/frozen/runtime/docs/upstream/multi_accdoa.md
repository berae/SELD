...
> Paper experiment mainline (2026-09-02): see `PROJECT_STATUS.md` and
> `EXPERIMENT_PROTOCOL.md`. New A0–A3/C0–C3 runs use the strict-causal shared
> frontend and train-fold-only normalization defined there. The remainder of
> this file is the upstream DCASE baseline documentation.
