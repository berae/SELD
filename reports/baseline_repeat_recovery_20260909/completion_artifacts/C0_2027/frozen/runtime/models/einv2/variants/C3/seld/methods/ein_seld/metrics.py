...
from methods.utils.SELD_evaluation_metrics_aligned import \
    SELDMetrics as SELDMetrics2020
from methods.utils.SELD_evaluation_metrics_aligned import early_stopping_metric
...
class Metrics(object):
    ...
    def __init__(self, cfg, dataset):
        ...
        self.metric_protocol = 'dcase2023_micro_full_duration'
        self.metrics = []
        self.names = ['ER20', 'F20', 'LE20', 'LR20', 'seld20', 'ER19', 'F19', 'LE19', 'LR19', 'seld19']
        self.names += ['velocity_l2_mae', 'velocity_cosine']
        self.names += ['jepa_loss_{}ms'.format(int(offset) * 100)
                       for offset in cfg['training']['jepa_horizons_frames']]
        self.names += ['target_latent_std_mean', 'target_latent_std_min',
                       'target_latent_cov_offdiag_abs_mean',
                       'target_latent_pair_cosine_mean']
