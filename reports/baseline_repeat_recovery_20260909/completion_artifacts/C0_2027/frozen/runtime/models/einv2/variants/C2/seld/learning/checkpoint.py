...
class CheckpointIO:
    ...
    def __init__(self, checkpoints_dir, model, optimizer, batch_sampler, metrics_names,
                 num_checkpoints=1, remark=None, extra_modules=None):
        """
        Args:
    ...
    def save_file(self, checkpoint_path, epoch, it):
        ...
        outdict = {
            ...
            'extra_modules': {
                name: (module.module.state_dict() if hasattr(module, 'module') else module.state_dict())
    ...
    def load(self, checkpoint_path):
        ...
        for name, module in self.extra_modules.items():
            if name in state_dict.get('extra_modules', {}):
                target_module = module.module if hasattr(module, 'module') else module
                target_module.load_state_dict(state_dict['extra_modules'][name])
