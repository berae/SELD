...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        evaluate_test=os.environ.get('SELD_EVALUATE_TEST', '1') != '0',
        ...
        use_velocity=False,
        use_jepa=False,
        lambda_velocity=float(os.environ.get('SELD_LAMBDA_VELOCITY', '0.2')),
        lambda_jepa=float(os.environ.get('SELD_LAMBDA_JEPA', '0.2')),
        velocity_dt=0.1,
