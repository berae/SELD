...
class Preprocess:
    ...
    def extract_PIT_label(self):
        ...
        """
        # STARSS23 contains four rare frames with six simultaneous targets.
        # Keep the published three-track training target (slice below), but
        # allocate six temporary slots so parsing those frames does not fail.
        num_tracks = 6
