...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_TAU2020/data/TAU2020_SELD_dataset',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='/work/zhanghc/Myllm/SELD/CausalMultiACCDOA_TAU2020/features/tau2020_foa_multiaccdoa',
 
        model_dir='/work/zhanghc/Myllm/SELD/CausalMultiACCDOA_TAU2020/runs/models/',
        dcase_output_dir='/work/zhanghc/Myllm/SELD/CausalMultiACCDOA_TAU2020/runs/results/',
    ...
    if argv == '1':
        ...
        print("FOA + multi ACCDOA TAU2020 EVALUATION PROTOCOL\n")
        params['quick_test'] = False
        params['mode'] = 'eval'
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        ...
        print("FOA + multi ACCDOA TAU2020 EVALUATION QUICK SMOKE\n")
        params['quick_test'] = True
        params['mode'] = 'eval'
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        ...
        print("FOA + CAUSAL multi ACCDOA TAU2020 EVALUATION QUICK SMOKE\n")
        params['quick_test'] = True
        params['mode'] = 'eval'
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
        ...
        print("FOA + CAUSAL multi ACCDOA TAU2020 EVALUATION PROTOCOL\n")
        params['quick_test'] = False
        params['mode'] = 'eval'
        params['dataset'] = 'foa'
        params['multi_accdoa'] = True
