...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        feat_label_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_TAU2020/features/tau2020_foa_multiaccdoa',
 
        model_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_TAU2020/runs/models/',
        dcase_output_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_TAU2020/runs/results/',
