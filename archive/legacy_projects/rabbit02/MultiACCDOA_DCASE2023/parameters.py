...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_DCASE2023/data/DCASE2023_SELD_dataset',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_DCASE2023/features/seld_feat_label',
 
        model_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_DCASE2023/runs/models/',
        dcase_output_dir='/work/zhanghc/Myllm/SELD/MultiACCDOA_DCASE2023/runs/results/',
